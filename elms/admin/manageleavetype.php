...
{               ?>  
                                        <tr>
                                            ...
                                            <td><a href="editleavetype.php?lid=<?php echo htmlentities($result->id);?>"><i class="">Edit</i></a>
                                            <a href="manageleavetype.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="">Delete</i></a> </td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                </table>
