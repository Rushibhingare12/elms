                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <ul class="right col s9 m3 nav-right-menu">
                            ...
                            <li class="hide-on-small-and-down"><a href="javascript:void(0)" data-activates="dropdown1" class="dropdown-button dropdown-right show-on-large"><i class="">Notifications</i>
<?php 
$isread=0;
...
{               ?>  
                                    ...
                                    <li>
                                        ...
                                        <div class="notification">
                                            <div class="notification-icon circle cyan"><i class=""></i></div>
