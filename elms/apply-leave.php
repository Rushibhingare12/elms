...
<input placeholder="" id="mask1" name="fromdate" class="datepicker picker__input picker__input--active" autocomplete="off" readonly tabindex="-1" aria-haspopup="true" aria-readonly="false" type="text" data-inputmask="'alias': 'date'" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">To Date</label>
<input placeholder="" id="mask1" name="todate" class="datepicker picker__input picker__input--active" autocomplete="off" type="text" data-inputmask="'alias': 'date'" required>
</div>
